#let project(
  ...
  let zh_shusong = ("New Computer Modern", "Songti SC")
  let zh_xiaobiansong = ("New Computer Modern", "Songti SC")
  let zh_kai = ("New Computer Modern", "Songti SC")
  let zh_hei = ("New Computer Modern", "Songti SC")
